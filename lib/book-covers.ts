const REAL_BOOK_COVER_PATHS: Record<string, string> = {
  ...
  // --- 7A launch wire-in covers (slug-named webp; avif sibling resolved by getBookCoverCandidates) ---
  "blink": "/book-covers/blink.webp",
  "contagious": "/book-covers/contagious.webp",
  "daring-greatly": "/book-covers/daring-greatly.webp",
  "drive": "/book-covers/drive.webp",
  "flow": "/book-covers/flow.webp",
  "grit": "/book-covers/grit.webp",
  "hooked": "/book-covers/hooked.webp",
  "mans-search-for-meaning": "/book-covers/mans-search-for-meaning.webp",
  "meditations": "/book-covers/meditations.webp",
  "mindset": "/book-covers/mindset.webp",
  "never-eat-alone": "/book-covers/never-eat-alone.webp",
  "noise": "/book-covers/noise.webp",
  "on-becoming-a-person": "/book-covers/on-becoming-a-person.webp",
  "skin-in-the-game": "/book-covers/skin-in-the-game.webp",
  "start-with-why": "/book-covers/start-with-why.webp",
  "the-5-am-club": "/book-covers/the-5-am-club.webp",
  "the-7-habits-of-highly-effective-people": "/book-covers/the-7-habits-of-highly-effective-people.webp",
  "the-denial-of-death": "/book-covers/the-denial-of-death.webp",
  "the-let-them-theory": "/book-covers/the-let-them-theory.webp",
  "the-obstacle-is-the-way": "/book-covers/the-obstacle-is-the-way.webp",
  "the-pyramid-principle": "/book-covers/the-pyramid-principle.webp",
  "the-tipping-point": "/book-covers/the-tipping-point.webp",
  "unreasonable-hospitality": "/book-covers/unreasonable-hospitality.webp",
};
