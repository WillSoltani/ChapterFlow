...
- 2026-04-12T18:42:36-03:00 Phase 0 manifest lock confirmed for `ego-is-the-enemy` by Ryan Holiday. Output profile `flagship_v4_compatible`, validation mode `chapter_gate`, chapter gate `automatic_continue`, source discovery `web_bundle`, source policy `public_or_authorized_plus_secondary`, wave size `2`.
