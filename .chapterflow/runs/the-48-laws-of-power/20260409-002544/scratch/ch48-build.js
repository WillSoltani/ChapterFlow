  ...
  contentVariants: {
    ...
    medium: {
      ...
      keyTakeaways: [
        ...
        {
          point: tone("The chapter has a coherence and trust limit.", "Some situations require visible stability and dependable commitments.", "Formlessness fails when it dissolves the reliability others still need to see."),
