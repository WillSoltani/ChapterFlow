...
## The Charisma Myth guardrails
- Source bundle is paraphrase-first and thinner than full text. Stay narrow when support is thin.
- The current edition includes `Digital Charisma`; do not backfill the older `The Charismatic Life` chapter.
- Applied chapters should remain practical and situational, not life-coaching fluff.
- Because the source bundle only partly exposes the book's science claims, later briefs should mark unsupported zones aggressively before prose starts.
