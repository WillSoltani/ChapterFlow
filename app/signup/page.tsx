...
function GoogleIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z" fill="var(--cf-brand-google-blue)" />
      <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="var(--cf-brand-google-green)" />
      <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="var(--cf-brand-google-yellow)" />
      <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="var(--cf-brand-google-red)" />
    </svg>
  );
}
    ...
    <AuthScreen>
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold leading-snug text-(--cf-text-1)">
            Start reading smarter
          </h1>
          <p className="mt-2 text-cf-body leading-relaxed text-(--cf-text-3)">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="inline-flex min-h-12 w-full items-center justify-center gap-3 rounded-xl border border-(--cf-border-strong) bg-(--cf-surface-muted) px-4 text-cf-body font-medium text-(--cf-text-1) transition-colors duration-(--duration-fast) hover:bg-(--cf-surface-strong)"
          >
            <GoogleIcon />
        ...
        <div className="my-6 flex items-center gap-4">
          ...
          <span className="text-cf-label text-(--cf-text-3)">or</span>
          <div className="h-px flex-1 bg-(--cf-border)" />
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <input
            ...
            className="min-h-12 w-full rounded-xl border border-(--cf-border-strong) bg-(--cf-surface-muted) px-4 text-cf-body text-(--cf-text-1) placeholder:text-(--cf-text-3) transition-colors duration-(--duration-fast) focus:border-(--cf-accent)"
          />
          ...
          {emailHint && (
            <p
              ...
              role="alert"
              className="-mt-1 text-cf-label leading-relaxed text-(--cf-danger-text)"
            >
          ...
          <button
            ...
            onClick={startEmail}
            aria-describedby={emailDescribedBy}
            className="inline-flex min-h-12 w-full items-center justify-center rounded-xl bg-(--cf-accent) px-4 text-cf-body font-semibold text-(--cf-accent-contrast) transition duration-(--duration-fast) hover:brightness-110"
          >
        ...
        {/* Sign in link */}
        <p className="mt-5 text-center text-cf-body-sm text-(--cf-text-3)">
        ...
        <p className="mt-6 text-center text-cf-label leading-relaxed text-(--cf-text-3)">
        ...
        {/* Trust line */}
        <p className="mt-2 text-center text-cf-label text-(--cf-text-3)">
