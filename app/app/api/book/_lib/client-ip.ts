...
// Shared client-IP + coarse-network helpers.
//
...
// prefix identically. Previously each file kept its own copy; they drifted
// (some read the spoofable leftmost XFF token, and the IPv6 prefix logic
// diverged), so a fingerprint written by one system was invisible to another.
