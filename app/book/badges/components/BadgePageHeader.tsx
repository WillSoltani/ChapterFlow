  ...
  return (
    <div>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-3">
        {/* Earned stat */}
        <div className="flex items-center gap-3 rounded-2xl border border-(--cf-border) bg-(--cf-surface-muted) px-4 py-3.5 backdrop-blur-xl">
        ...
        {/* Reader Level */}
        <div className="rounded-2xl border border-(--cf-border) bg-(--cf-surface-muted) px-4 py-3.5 backdrop-blur-xl">
