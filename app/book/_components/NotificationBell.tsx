  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-(--cf-accent) px-1 text-[10px] font-bold text-(--cf-accent-contrast)">
