#!/usr/bin/env node
// Detects shared 6+ word phrases in competing-against-luck.v21.json quiz
...
const FILE = path.resolve(__dirname, '../../book-packages/competing-against-luck.v21.json');
...
function main() {
  ...
  console.log(`\nChapters with shared phrases: ${totalBad}/10`);
}
