#!/usr/bin/env node
// Detects shared 6+ word phrases in the-laws-of-human-nature.v21.json quiz
...
const FILE = path.resolve(__dirname, '../../book-packages/the-laws-of-human-nature.v21.json');
...
function main() {
  ...
  console.log(`\nChapters with shared phrases: ${totalBad}/19`);
}
