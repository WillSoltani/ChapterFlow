#!/usr/bin/env node
// Detects shared 6+ word phrases in quiz prompts across zero-to-one.v21.json
...
const FILE = path.resolve(__dirname, '../../book-packages/zero-to-one.v21.json');
...
function main() {
  ...
  console.log(`\nChapters with shared phrases: ${totalBad}/14`);
}
