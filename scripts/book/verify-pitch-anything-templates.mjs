#!/usr/bin/env node
// Detects shared 6+ word phrases in pitch-anything.v21.json
...
const FILE = path.resolve(__dirname, '../../book-packages/pitch-anything.v21.json');
...
function main() {
  ...
  console.log(`\nChapters with shared phrases: ${totalBad}/2`);
}
