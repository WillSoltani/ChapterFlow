...
export const CHAPTER_EDITOR_BRIEF: readonly string[] = Object.freeze([
  ...
  "MEMORABLE LINES. The lines a reader carries away state a PRINCIPLE. They are not pasted plot sentences and they do not turn on a source specific. If a candidate line only works because it names a case, rewrite it so the idea stands without the case.",
