...
export class BookRunApplicationService {
  ...
  async #reviewSuccessor(args: Readonly<{
    ...
    // built for; R-288 adds a SIBLING caller-established case (`disputed`).
    // Everything else about the gate, the walk and the ceiling is unchanged. See
    // reviewContradictsPassingPatternAudit for why that FAIL is uncertainty and
    // why every other FAIL stays a verdict.
