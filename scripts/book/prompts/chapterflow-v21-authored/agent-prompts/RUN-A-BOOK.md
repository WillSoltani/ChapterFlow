...
|---|-------|-----------------|------------------|-------------|
| 1 | Research | `RESEARCH-CODEX-SESSION.md` | `Research the book <book>` | `phase: write-chapter` — index + every source sidecar exist AND `source-verify` confirms each named case/fact is real (not just structurally valid) |
