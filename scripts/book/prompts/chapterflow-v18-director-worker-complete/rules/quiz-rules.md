...
## v18 Additional Quiz Rules

- The quiz worker may not reuse exact prompt stems within a chapter.
- q01-q03 should check chapter-local understanding, q04-q08 application, q09-q10 synthesis or boundary conditions.
- At least one question must test the chapter's boundary condition or strongest limit where the source supports it.
- If any explanation teaches the same principle as an earlier explanation without a new angle, rewrite it.
