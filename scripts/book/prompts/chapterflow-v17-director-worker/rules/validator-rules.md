...
## Additional v17 Prose Checks

Flag for repair if any reader-facing field contains internal-instruction language, source-splice contamination, or calibration-note leakage.
