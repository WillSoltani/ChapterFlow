...
export function writeKeyPacks(bookId: string, roundId: string, chapters: ChapterV21[] = loadBookChapters(bookId)): string[] {
...
export function resolveManualKeyJudges(bookId: string, roundId: string, chapters: ChapterV21[] = loadBookChapters(bookId)): { records: ManualKeyJudgeRecord[]; errors: string[] } {
  const errors: string[] = [];
