...
- empty `questions` array is a fail in chapter_gate mode
- scenario-based questions should stay readable inside the target grade band for the question's depth
