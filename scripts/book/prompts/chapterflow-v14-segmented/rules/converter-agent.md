...
## Additional v14 rules
- if scenarioTonePolicy = required, examples[].scenario must be a tone object
- do not copy brief instructions or source excerpts verbatim into reader-facing fields
- if a phrase sounds like a dossier note, cut it
