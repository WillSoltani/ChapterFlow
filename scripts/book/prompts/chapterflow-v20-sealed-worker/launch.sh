...
PACK_ROOT="scripts/book/prompts/chapterflow-v20-sealed-worker"
...
manifest = {
  ...
  "runProfile": "sealed_worker_balanced",
  ...
  "forbidContentGeneratorScripts": True,
  "releaseAssembleFromValidatedOnly": True,
  "workerSpawnMode": "fresh_session_per_stage",
  "coverPolicy": "manual_none_generated",
...
prompt = f"{starter}\n\nPACK_ROOT={pack_root}\nRUN_ROOT={run_root}\n\nRead in order:\n1. {pack_root}/README.md\n2. {pack_root}/OPERATING_CONTRACT.md\n3. {pack_root}/ARCHITECTURE.md\n4. {pack_root}/STATE_MACHINE.md\n5. {pack_root}/SOURCE_SUFFICIENCY.md\n6. {pack_root}/MasterDirector-v20.md\n7. {run_root}/manifests/run-manifest.json\n\nThen run the Director workflow exactly as written. If fresh worker sessions are unavailable, stop as blocked instead of simulating them.\n"
